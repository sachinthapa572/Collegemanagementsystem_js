...
import { createSubject, deleteSubject, getSubjects, updateSubject } from '../../controller/academics/courses.controller.js';

const courseRouter = Router();

courseRouter.use(isAuth(Admin), roleRestriction('admin'));

courseRouter.route('/:programId').post(createSubject).get(getSubjects);
